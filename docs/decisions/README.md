...
| [0012](0012-sea-current-and-sea-temperature-from-marine-api.md) | Surface sea current direction and sea surface temperature from Open-Meteo Marine | Accepted |
